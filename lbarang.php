              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="lbarang.php">Barang</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> Laporan Barang</h3>
          <div class="row mt">
            <div class="col-lg-12">
            <div class="form-panel">
              <form class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                       <label class="col-sm-2 col-sm-2 control-label" style="text-align: center; margin-top: 10px;">Cari Barang</label>
                        <div class="col-sm-6">
                           <input type="text" class="form-control" name="carr">
                        </div>
                        <div class="col-sm-4">
                           <input class="btn btn-info" type="submit" name="carii" value="CARI">
                           <a class="btn btn-success" href="lbarang.php">RESET</a>
                           <a class="btn btn-warning" href="laporanbarang.php">CETAK LAPORAN</a>
                        </div>
                  </div>
              </form>
              <br>
              ...
              if (isset($_POST['carii'])) {
                if (empty($_POST['carr'])) {
                  ...
                  $where = " where id like '%$_POST[carr]%' or name like '%$_POST[carr]%' or merk like '%$_POST[carr]%' or description like '%$_POST[carr]%' or quantity like '%$_POST[carr]%'";  
                }
              }
              ?>
              <section id="unseen">
      ...
      <footer class="site-footer">
          <div class="text-center">
              <a href="master.php#" class="go-top">
