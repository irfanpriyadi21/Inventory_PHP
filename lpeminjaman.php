          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a href="lpeminjaman.php">Peminjaman</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> Laporan Peminjaman</h3>
          <div class="row mt">
            <div class="col-lg-12">
            <div class="form-panel">
                  ...
                  <div class="form-group">
                       <label class="col-sm-2 col-sm-2 control-label" style="text-align: center; margin-top: 10px;">Pilih tanggal</label>
                        ...
                        <div class="col-sm-4">
                           ...
                           <a class="btn btn-success" href="lpeminjaman.php">RESET</a>
                           <a class="btn btn-warning" href="laporanpinjam.php">CETAK LAPORAN</a>
                        </div>
                  </div>
              </form>
              <br>
              ...
              if (isset($_POST['caritgl'])) {
                if (empty($_POST['tgl1']) || empty($_POST['tgl2'])) {
                  ...
                  $where = " where date BETWEEN '$_POST[tgl1]' and '$_POST[tgl2]'";
