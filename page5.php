...
<body>
  <section class="menu cid-qM8MRwKnNl" once="menu" id="menu1-13">
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="https://mobirise.com">Inventarisasi Alat Multimedia</a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
              ...
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="page1.php#features18-x">
              ...
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="Login.php#header15-o"><span class="mbri-user mbr-iconfont mbr-iconfont-btn"></span>
                  Login &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a>
              </li>
            </ul>
        </div>
...
<section class="engine">
  <a href="https://mobirise.ws/p">open source website maker</a>
</section>
<section class="mbr-section form1 cid-qM8Npa0q64 mbr-parallax-background" id="form1-19">
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Form Peminjaman</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">Silahkan isi form peminjaman bila ingin meminjam</h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="for moid">
                    <div data-form-alert="" hidden="">Terimakasih telah berpastisipasi !</div>
                    <form method=post>
                        <div class="row row-sm-offset">
                            ...
                            <div class="col-md-3 multi-horizontal" data-for="email">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7">Nis</label>
                                    <input type="text" class="form-control" name="email" data-form-field="Email" required="" id="email-form1-19">
                                </div>
                            </div>
                            <div class="col-md-3 multi-horizontal" data-for="phone">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="phone-form1-19">Rombel</label>
                        ...
                        <div class="row row-sm-offset">
                          <div class="col-md-3 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="name-form1-19">Nama Barang 1</label>
                              <select class="form-control" style="width :80%;" name="kode_barang">
                                <option></option>
                              <?php 
                            ...
                            <div class="col-md-3 multi-horizontal" data-for="email">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7">Jumlah</label>
                                    <input type="text" class="form-control" name="email" data-form-field="Email" required="" id="email-form1-19">
                                </div>
                            </div>
                         ...
                         <div class="row row-sm-offset">
                          <div class="col-md-3 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="name-form1-19">Nama Barang 2</label>
                              <select class="form-control" style="width :80%;" name="kode_barang">
                      <option></option>
                              <?php 
                                $sql="SELECT * FROM item WHERE quantity !='0'";
                         ...
                         <div class="row row-sm-offset">
                          <div class="col-md-3 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="name-form1-19">Nama Barang 3</label>
                              <select class="form-control" style="width :80%;" name="kode_barang">
                      <option></option>
                              <?php 
                                $sql="SELECT * FROM item WHERE quantity !='0'";
                        ...
                        <div class="form-group" data-for="message">
                            <label class="form-c  ontrol-label mbr-fonts-style display-7" for="message-form1-19">Message</label>
                        ...
                        <div style="margin-left: 70.5%">
                          <h6>Kepala Kompetensi Keahlian</h6>
                           <h6>Multimedia</h6>
                          <br>
                          <br>
                          <br>
                          <br>
                          <h6>(&nbsp;Eko Wigiantoro,S.Ds&nbsp;)</h6>
                        </div>
                      <?php if ($kokodean == "ada") {?>
                      <span class="input-group-btn">
                        <form method="post">
                          <a href="?print=ok" class="btn btn-danger">PRINT</a>
                        </form>
                      </span>
                    </form>
            </div>
...
<section class="cid-qM8MStR5Qa" id="footer1-14">
    <div class="container">
        <div class="media-container-row content text-white">
            ...
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                ...
                <p class="mbr-text">SMK WIKRAMA BOGOR Jln Raya wangun - Bogor&nbsp;<br>16837876</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
        ...
        <div class="media-container-row mbr-white">
          <div class="col-sm-6 copyright">
            <p class="mbr-text mbr-fonts-style display-7">
              © Copyright 2018 IBN - All Rights Reserved
            </p>
          </div>
        </div>
        </div>
